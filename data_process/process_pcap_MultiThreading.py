...
def main():
    ...
    parser.add_argument("--dataset", default="ISCX_VPN_2016_APP",
                        choices=["ISCX_VPN_2016","ISCX_VPN_2016_APP", "ISCX_Tor_2017", "CIC_IOT_2022", "USTC_TFC2016", "ISCX_Bot_2014", "CIC_IDS_2017", "VNAT", "CSTNET_TLS_1.3"])

    parser.add_argument("--packet_num", type=int, default=8)

    args = parser.parse_args()

    p = "/data/users/lph/datasets/ISCX_Dataset/ISCX_VPN_2016_APP/"
    all_items = glob.glob(os.path.join(p, '*'))
    dirs_label = [d for d in all_items if os.path.isdir(d)]

    tgt_dir = os.path.join("/data/users/lph/projects/WTMamba/datasets/ISCX_VPN_2016_APP","pcap")
